...
//                new MemorialListResponse(1, "홍길동", "N", "20200101", "M", 10, 12),
//                new MemorialListResponse(2, "김길동", "Y", "20211231", "F", 20, 22),
//                new MemorialListResponse(3, "나길동", "N", "20220101", "M", 30, 32)
//        );
//
//        Page<MemorialListResponse> page = new PageImpl<>(content, PageRequest.of(0,20), 3);
//
...
//        List<MemorialListResponse> content = List.of(
//                new MemorialListResponse(1, "홍길동", "N", "20200101", "M", 10 ,12),
//                new MemorialListResponse(2, "김길동", "Y", "20200102", "F", 20, 22),
//                new MemorialListResponse(3, "나길동", "N", "20220103", "M", 30, 32)
//        );
//
//        Page<MemorialListResponse> page = new PageImpl<>(content, PageRequest.of(0,20), 3);
...
//        );
//
//        MemorialDetailResponse.builder()
//                .donateSeq(1)
//                .donorName("홍길동")
//                .anonymityFlag("N")
//                .donateTitle("당신을 기억합니다.")
